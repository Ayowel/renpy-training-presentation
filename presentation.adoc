...
ifndef::disable-section-renpy-info[]
...
Assets utilisés: https://github.com/Ayowel/renpy-training-presentation/releases/latest
...
ifndef::disable-section-what-can-be-done[]
...
[.notes]
--
Colors est un petit jeu fait en deux mois qui vise les enfants et alterne phases de narration et mini-jeux
...
ifndef::disable-section-create-new-game[]
...
ifndef::disable-section-game-components[]
...
ifndef::disable-section-positioning[]
...
ifndef::disable-section-make-a-game[]
...
ifndef::disable-section-translation[]
...
ifndef::disable-section-go-further[]
...
ifndef::disable-section-screen-components[]
...
[.notes]
--
`fixed` est un élément de structure pour les écrans qui permet de créer des zones d'affichages arbitraires dans un écran.

`hbox`/`vbox` créent des lignes/colonnes où chaque élément s'ajoute à la suite des précédents dans la liste.

`grid` crée des tableaux, chaque élément mis dans la grille en devient une nouvelle cellule.
--

// TODO: add frame and window usage

endif::[]
ifndef::disable-section-go-much-further[]
...
ifndef::disable-section-go-too-far[]
...
https://discord.com/invite/tnXvXKH6jZ
