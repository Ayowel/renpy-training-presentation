...
// TODO: move content to end, only show screens and explain how to change them
...
// TODO: move to end and speak about styles
...
// TODO: add string interpolation & player's character naming
